...
const NameSelectBottomSheet = ({onPress ={} , bottomSheetRef = "",selectedNameValue,Name}) => {
  ...
  return (
    ...
    >
      ...
      <View style={{marginTop:20,paddingHorizontal:25,marginBottom:40}}>
        <Text style={[styles.title,{fontFamily:SEMIBOLD,textAlign:"center",textTransform:"capitalize",fontSize:FontSize.FS_14}]}>{"Select Name"}</Text>
      <FlatList
        data={Name}
...
export default NameSelectBottomSheet