...
const TimeSelectBottomSheet = ({onPress ={} , bottomSheetRef = "",selectedValue, headerTitle = ""}) => {
  ...
  return (
    ...
    >
      ...
      <View style={{marginTop:20,paddingHorizontal:25,marginBottom:40}}>
        <Text style={[styles.title,{fontFamily:SEMIBOLD,textAlign:"center",textTransform:"capitalize",fontSize:FontSize.FS_14}]}>{headerTitle}</Text>
      <FlatList
        data={SINGLETIMEOUT}
