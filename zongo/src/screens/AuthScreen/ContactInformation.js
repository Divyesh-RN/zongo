...
import { Check_User_Email } from '../../redux/api/Api';
          ...
          <View style={{ alignItems: 'center', marginTop: '8%', }}>
            <View style={{ flex: 1 }}>
              <ProgressSteps>
                ...
                <ProgressStep finishBtnText={"Continue to Pay"} label="" onSubmit={() => onConfirm()} >
                <View style={{ alignItems: 'center', }}>
                    <View >
                    <Text style={[styles.welcomeTextLogin,{marginHorizontal:20}]}>
                      {"Payment Information"}
                    </Text>
