...
const RouteDestinationBottomSheet = ({data=[], bottomSheetRef = "", selectedValue, headerTitle = "",currentValue = "",selectedRoute }) => {
...
export default RouteDestinationBottomSheet